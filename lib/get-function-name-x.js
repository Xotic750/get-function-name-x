...
if (t.name === 'test1') {
  ...
  var stringMatch = _dereq_('cached-constructors-x').String.prototype.match;
  getName = function _getName(fn) {
    var match;
    try {
...
},{"cached-constructors-x":3,"is-function-x":7,"normalize-space-x":12,"replace-comments-x":13}],2:[function(_dereq_,module,exports){
/**
