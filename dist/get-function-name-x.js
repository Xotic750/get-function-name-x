...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["getFunctionNameX"] = factory();
	else
		root["getFunctionNameX"] = factory();
})((function () {
  'use strict';
...
// CONCATENATED MODULE: ./dist/get-function-name-x.esm.js
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return getFunctionName; });
...
if (t.name === 'test1') {
  ...
  var get_function_name_x_esm_fToString = functionCtr.toString;
  ...
  $getName = function getName(fn) {
    ...
    try {
      match = stringMatch.call(normalizeSpace2018(replaceComments(get_function_name_x_esm_fToString.call(fn), ' ')), reName);
...
//# sourceMappingURL=get-function-name-x.js.map